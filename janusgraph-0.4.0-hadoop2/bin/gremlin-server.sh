...
if [ "$JAVA_OPTIONS" = "" ] ; then
    JAVA_OPTIONS="$ADDITIONAL_JAVA_OPTS -javaagent:$JANUSGRAPH_LIB/jamm-0.3.0.jar -Dgremlin.io.kryoShimService=org.janusgraph.hadoop.serialize.JanusGraphKryoShimService"
fi
